...
Draws a few free-running samples from a checkpoint. For running inference over a
whole file / sample of prompts, use inference.py instead.
"""
import os
import pickle
...
start = "\n" # or any prompt string. Can also specify a file, use as: "FILE:prompt.txt"
...
# use the architecture the checkpoint recorded, falling back to the --model flag
